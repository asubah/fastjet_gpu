...
NVCC_FLAGS=-std=c++14 -O2 --expt-relaxed-constexpr --expt-extended-lambda -g --generate-line-info --source-in-ptx --generate-code arch=compute_61,code=sm_61 -I$(CUB_INCLUDE_PATH)
